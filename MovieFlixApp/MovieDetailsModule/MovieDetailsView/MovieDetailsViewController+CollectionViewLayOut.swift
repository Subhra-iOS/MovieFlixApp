...
extension MovieDetailsViewController{
    ...
    func detailsCollectionViewLayoutSetup(){
        ...
        layout.itemSize = CGSize(width: sizeCollectionViewItem.width, height: sizeCollectionViewItem.width + 150)
    ...
    private func collectionViewitemSize(collectionView:UICollectionView) -> CGSize{
        ...
        return CGSize(width: sizeCollectionViewItem.width, height: sizeCollectionViewItem.width + 150)
